...
exports.set_proxy = exports.request = exports.get_session = void 0;
...
var sess = null;
var user_proxy = null;
function getAxiosInstance(_a) {
    var _b = _a.credential, credential = _b === void 0 ? new Credential_1.Credential({}) : _b, _c = _a.proxy, proxy = _c === void 0 ? null : _c;
...
function get_session(_a) {
    var _b = _a.credential, credential = _b === void 0 ? new Credential_1.Credential({}) : _b;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getAxiosInstance({ credential: credential, proxy: user_proxy })];
                case 1: return [2 /*return*/, _c.sent()];
                case 2: return [4 /*yield*/, getAxiosInstance({ credential: credential })];
...
function request(_a) {
    var method = _a.method, url = _a.url, _b = _a.params, params = _b === void 0 ? {} : _b, _c = _a.data, data = _c === void 0 ? {} : _c, _d = _a.credential, credential = _d === void 0 ? new Credential_1.Credential({}) : _d, _e = _a.no_csrf, no_csrf = _e === void 0 ? false : _e;
    return __awaiter(this, void 0, void 0, function () {
        var DEFAULT_HEADERS, headers, cookies, config, resp, has_content_type, resp_data, code, msg, real_data;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 5: return [4 /*yield*/, (_f.sent()).request(config)];
                case 6:
                    resp = _f.sent();
