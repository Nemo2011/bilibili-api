...
- 调用简便，函数命名易懂，代码注释详细。
- 不仅仅是官方提供的API！还附加：AV号与BV号互转[[2]](#脚注)、连接直播弹幕Websocket服务器、视频弹幕反查、专栏内容爬取[[3]](#脚注)等。
- 更多功能请参照 [开发文档][docs]。
...
```
$ pip install bilibili_api==2.0.0.beta.1
```
