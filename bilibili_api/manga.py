...
async def get_raw_index(area: MangaIndexFilter.Area = MangaIndexFilter.Area.ALL,
...
async def get_index(area: MangaIndexFilter.Area = MangaIndexFilter.Area.ALL,
                            order: MangaIndexFilter.Order = MangaIndexFilter.Order.HOT,
                            status: MangaIndexFilter.Status = MangaIndexFilter.Status.ALL,
                            payment: MangaIndexFilter.Payment = MangaIndexFilter.Payment.ALL,
                            style: MangaIndexFilter.Style = MangaIndexFilter.Style.ALL,
    ...
    Returns:
        List[Manga]: 漫画索引
    """
    data = await get_raw_index(area, order, status, payment, style, pn, ps)
