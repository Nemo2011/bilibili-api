...
[http://127.0.0.1:9000/video.Video(bvid="BV1ju411T7so").get_aid()](http://127.0.0.1:9000/video.Video(bvid="BV1ju411T7so").get_aid())

此外，你也可以使用一个可被解析的值作为参数值，例如：

[http://127.0.0.1:9000/channel_series.ChannelSeries(id_=1845727,uid=148524702,type_=channel_series.ChannelSeriesType.SEASON).get_meta()](http://127.0.0.1:9000/channel_series.ChannelSeries(id_=1845727,uid=148524702,type_=channel_series.ChannelSeriesType.SEASON).get_meta())
